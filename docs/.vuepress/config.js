...
module.exports = {
  ...
  themeConfig: { // 主题配置
    ...
    footer:{ // 页脚信息
      ...
      copyrightInfo: 'guqzhou | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    },
    htmlModules
  },
  plugins: [ // 插件
